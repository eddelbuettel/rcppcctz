...
##'
##' @description CCTZ contains two underlying libraries which build on the C++11
...
##'
##' @details CCTZ requires a valid timezone library as well as recent-enough
...
##'
##' @author Dirk Eddelbuettel wrote the package; Dan Dillon ported
##'     \code{std::get_time} from LLVM's libc++; Bradley White and Greg Miller
##'     wrote the underlying CCTZ library.
##'
##'     Maintainer: Dirk Eddelbuettel <edd@debian.org>
##'
##' @references The CCZT repository at \url{https://github.com/google/cctz} has
##'     additional information.
##'
##' @docType package
##' @name RcppCCTZ-package
##' @aliases RcppCCTZ
